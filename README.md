...
execute if score origins-limiter.major load matches 1.. if score origins-limiter.minor load matches 4.. run say Datapack loaded! :D


#   Check if v1.4.0 of origins-limiter is NOT loaded
execute unless score origins-limiter.major load matches 1.. if score origins-limiter.minor load matches 4.. run say Missing origins-limiter_v1.4.0 dependency! D:
```
