...
tellraw @a {"translate": "%1$s failed to load! Missing dependency: %2$s \n", "color": "red", "with": [{"text": "origins-limiter_example", "color": "yellow"}, {"text": "origins-limiter_v3.1.0 or newer", "color": "yellow", "clickEvent": {"action": "open_url", "value": "https://github.com/eggohito/origins-limiter/releases"}}]}
