#   Set the max count for this origin ONCE (can be changed in-game)
...
#   Count how many players currently have this origin
    ...
    ##  Grant the player an advancement to indicate that the max count for this origin has been reached
    #
    #   * the advancement is used for the origin layer
