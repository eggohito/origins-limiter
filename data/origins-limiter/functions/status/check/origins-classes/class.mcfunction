...
execute if data storage origins-limiter:main temp.component.origins[{Origin: "origins-limiter:status/cancel", Layer: "origins-limiter:status/origins-classes/class"}] run function origins-limiter:status/cancel/origins-classes/class

execute if data storage origins-limiter:main temp.component.origins[{Origin: "origins-limiter:status/override", Layer: "origins-limiter:status/origins-classes/class"}] run function origins-limiter:status/override/origins-classes/class
