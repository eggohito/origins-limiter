...
execute if score origins-limiter.major load matches 2 if score origins-limiter.minor load matches 2 run scoreboard players reset #loaded o-l.main

execute if score origins-limiter.major load matches 2 if score origins-limiter.minor load matches 2 run data remove storage origins-limiter:main root
