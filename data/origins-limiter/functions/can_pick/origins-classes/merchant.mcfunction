...
execute store result score origins-classes:merchant o-l.cur if entity @a[nbt = {cardinal_components: {"origins:origin": {OriginLayers: [{Origin: "origins-classes:merchant"}]}}}]
