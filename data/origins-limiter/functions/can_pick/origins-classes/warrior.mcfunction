...
execute store result score origins-classes:warrior o-l.cur if entity @a[tag = !origins-limiter.ignore, nbt = {cardinal_components: {"origins:origin": {OriginLayers: [{Origin: "origins-classes:warrior"}]}}}]
